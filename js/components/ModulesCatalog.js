...
function emptyForm() { return { id: null, name: '', group_name: '', price: 0, note: '', featuresText: '' }; }
...
export default {
  ...
  setup() {
    ...
    function openEdit(row) {
      Object.assign(form, { id: row.id, name: row.name, group_name: row.group_name, price: row.price, note: row.note,
    ...
    async function save() {
      ...
      const payload = { name: form.name, group_name: form.group_name, price: form.price, note: form.note };
      try {
