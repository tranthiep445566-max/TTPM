...
## 3.6. Cập nhật cho tính năng Xuất báo giá / Xuất hợp đồng (chạy 1 lần)

Để dùng được 2 nút **Xuất báo giá** và **Xuất hợp đồng** trên trang Dự án, cần chạy thêm:

1. Mở [`sql/migration_003_export_hopdong_baogia.sql`](sql/migration_003_export_hopdong_baogia.sql), copy toàn bộ, dán vào SQL Editor, bấm **Run**. File này bổ sung: địa chỉ/mã số thuế/người đại diện cho Khách hàng và Công ty (để điền vào hợp đồng), số hợp đồng/số báo giá lưu trên dự án, mô tả thời điểm thanh toán cho từng đợt, và độ khó của module (hiển thị nhãn trên phiếu báo giá).
2. Sau khi chạy xong, vào **Cài đặt > Công ty** để nhập Mã số thuế, Người đại diện, Chức vụ của công ty bạn — đây là thông tin "Bên B" sẽ tự động điền vào hợp đồng.
3. Vào **Khách hàng**, sửa từng khách hàng để bổ sung Địa chỉ, Mã số thuế, Người đại diện — đây là thông tin "Bên A" trong hợp đồng. Thiếu trường nào thì hợp đồng sẽ để chỗ trống (dấu ……) để bạn tự điền tay.
...
- **Xuất báo giá / Xuất hợp đồng**: vào 1 Dự án bất kỳ, bấm nút **🧾 Xuất báo giá** hoặc **📄 Xuất hợp đồng** ở đầu trang. Cả 2 đều lấy dữ liệu module, khách hàng, tiến độ, bảo hành... trực tiếp từ dự án; có thể **In / Lưu PDF** ngay, hoặc **Tải file Word (.doc)** riêng cho hợp đồng để chỉnh sửa thêm trong Word.
