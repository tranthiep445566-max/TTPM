    ...
    <div class="page">
      ...
      <template v-else>
        <div v-show="activeTab === 'company'" class="detail-card">
          ...
          <p class="muted small" style="margin:16px 0 8px">Thông tin pháp lý dưới đây dùng để điền tự động vào Bên B khi xuất hợp đồng.</p>
          ...
          <div class="form-row">
            ...
            <div class="form-group"><label>Chức vụ</label><input class="input" v-model="form.representative_position" /></div>
          </div>
