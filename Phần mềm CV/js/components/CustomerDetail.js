    ...
    <div class="page" v-if="!loading && customer">
      ...
      <div class="detail-grid">
        <div class="detail-card">
          ...
          <p><b>Mã số thuế:</b> {{ customer.tax_code || '—' }}</p>
          <p><b>Người đại diện:</b> {{ customer.representative_name || '—' }}<span v-if="customer.representative_position"> ({{ customer.representative_position }})</span></p>
